...
class UsuariosController extends Controller
{
    public function create(Request $request)
    {
        ...
        if ($request->Opcion === 'Administrador') {
            return $this->AltaDeAdministrador($Usuario->id, $request->password);
        }
        if ($request->Opcion === 'Cliente') {
            return $this->AltaDeCliente($Usuario->id);
        }
    }
